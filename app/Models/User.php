 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereSmsVerify($value)
 * @method static \Illuminate\Database\Eloquent\Builder|User whereSmsVerifyCode($value)
